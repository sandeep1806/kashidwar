...
/**
 * Seven tiered aarti lamps (static SVG, server-rendered inside <Static>).
 * <AartiFlames> animates the flames by finding #aarti-lamps.
 */
export default function AartiLamps() {
  return (
    <div id="aarti-lamps" className="relative mx-auto flex max-w-5xl items-end justify-center gap-3 sm:gap-6 lg:gap-10" aria-hidden="true">
